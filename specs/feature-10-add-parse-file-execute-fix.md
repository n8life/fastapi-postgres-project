# Feature 10: Read Files from issues and fix code base
...
## Tasks
- create a new endpoint to read files in @issues/
-- get the file names
-- add a new record in message table in postgres
--- read @agent_tables.sql for refernce.
-- the end point should send the name of the file, all other fields required for a message
